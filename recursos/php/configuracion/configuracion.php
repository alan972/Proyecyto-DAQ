           ...
           <h5 class="uk-text-center">Buscar usuario</h5>
            <form action="configuracion.php?tipo=buscar" method="post" class="uk-form-stacked">
                ...
                <div class="uk-text-center">
                    <button class="uk-button uk-button-primary" name="buscar">Buscar</button>
                </div>
            </form>
            <?php
...
?>
        <tr>
            ...
            <td><a href="script.php?tipo=borrar&id=';
            echo $id;
            echo '" class="uk-button uk-button-secondary">Borrar</a>
            <td><a href="script.php?tipo=modificar&id=';
            echo $id;
...
if($tipo == "modificar"){
    ...
    if($id){
        ...
        <div class="uk-text-center">
            ...
            <input type="text" class="uk-input uk-form-width-medium" name="apellido" value= <?php echo $row['apellido'] ; ?>>
            ...
            <input type="text" class="uk-input uk-form-width-medium" name="carrera" value = <?php echo $row['carrera']; ?>>
            <label for="" class="uk-form-label">Telefono</label>
            <input type="text" class="uk-input uk-form-width-medium" name="tel" value = <?php echo $row['telefono']; ?>>
            <label for="" class="uk-form-label">Email</label>
            <input type="text" class="uk-input uk-form-width-medium" name="email" value = <?php echo $row['email']; ?>>
